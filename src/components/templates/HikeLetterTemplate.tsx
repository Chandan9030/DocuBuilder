    ...
    <div className="bg-white w-full max-w-[900px] mx-auto font-sans">
      ...
      <div className="pdf-page bg-white min-h-[900px] w-full border border-gray-300 page-break-after">
        ...
        <div className="p-2">
          ...
          <div className="mb-6">
            <p className="font-bold text-sm">NAME: {recipientName}</p>
            <p className="font-bold text-sm">EMPLOYEE ID: {employeeId}</p>
          </div>
      ...
      <div className="pdf-page bg-white min-h-[900px] w-full border border-gray-300 page-break-after">
        ...
        <div className="p-6">
          ...
          <div className="text-center mb-4">
            ...
            <h2 className="text-lb font-bold underline mt-4">GUIDELINES</h2>
          </div>
