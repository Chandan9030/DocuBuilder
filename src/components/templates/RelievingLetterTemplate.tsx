...
const RelievingLetterTemplate: React.FC<RelievingLetterTemplateProps> = ({ formData = {}, templateContent }) => {
  ...
  // Format both dates to ordinal format
  const formattedReferenceDate = formatDateToOrdinal(referenceDate || '');
  const formattedRelievingDate = formatDateToOrdinal(relievingDate || '');
      ...
      <div className="p-8">
        <div className="flex justify-end mb-8">
          <div className="text-right">
            ...
            <p className="font-bold">{formattedReferenceDate}</p>
          </div>
        </div>
        ...
        <div className="text-justify leading-relaxed mb-8 relative z-10">
          ...
          <p className="mb-4">
            This is to inform you that your resignation has been accepted and you are being relieved from the services of <strong>Daya Consultancy Services Pvt. Ltd.</strong> at the close of working hours on <strong>{formattedRelievingDate || relievingDate}</strong>.
          </p>
          <p className="mb-4">
