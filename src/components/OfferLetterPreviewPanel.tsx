...
const OfferLetterPreviewPanel: React.FC<OfferLetterPreviewPanelProps> = ({
    formData,
    isGeneratingPDF,
    setIsGeneratingPDF,
    setFilePath,
    ...
    const renderTemplate = () => {
        return <OfferLetterTemplate formData={formData} />;
    };

    const getTemplateTitle = () => {
        return `offer_letter_${formData.recipientName.replace(/\s+/g, '_')}`;
    };
    ...
    const handleSendEmail = async () => {
        ...
        try {
            await sendSingleDocumentByEmail('offerLetter', formData, recipientEmail);
...
export default OfferLetterPreviewPanel;