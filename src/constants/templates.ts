...
//   { id: 'paymentReceipt', name: 'Payment Receipt' }
// ];
...
//   internshipThirdStatement: 'In addition, you agree that, upon conclusion of your internship, you will immediately return to the Company all its property, equipment, and documents, including electronically stored information.',
//   internshipFourthStatement: 'By accepting this offer, you agree that throughout your internship, you will observe all policies and practices governing the conduct of our business and employees, including our policies prohibiting discrimination and harassment. This letter sets forth the complete offer we are extending to you, and supersedes and replaces any prior inconsistent statements or discussions. It may be changed only by a subsequent written agreement. If any kind of unprofessional activity is being seen then legal actions may be taken against you.',
...
//   // Payment Receipt Template Fields
...
// const paymentReceiptFields = [
//   { id: 'paymentDate', label: 'Payment Date', type: 'date', placeholder: 'Enter payment date' },
//   { id: 'receiptNo', label: 'Receipt Number', type: 'text', placeholder: 'Enter receipt number' },
//   { id: 'studentName', label: 'Student Name', type: 'text', width: 'large', placeholder: 'Enter student name' },
//   { id: 'registrationNo', label: 'Registration Number', type: 'text', placeholder: 'Enter registration number' },
//   { id: 'courseName', label: 'Course Name', type: 'text', placeholder: 'Enter course name' },
//   { id: 'contact', label: 'Contact', type: 'text', placeholder: 'Enter contact number' },
//   { id: 'address', label: 'Address', type: 'textarea', placeholder: 'Enter address' },
//   { id: 'duration', label: 'Duration', type: 'text', placeholder: 'Enter course duration' },
//   { id: 'courseFees', label: 'Course Fees', type: 'text', placeholder: 'Enter course fees' },
//   { id: 'totalAmountPaid', label: 'Total Amount Paid', type: 'text', placeholder: 'Enter total amount paid' },
//   { id: 'paymentMethod', label: 'Payment Method', type: 'text', placeholder: 'Enter payment method' },
//   { id: 'upiId', label: 'UPI ID', type: 'text', placeholder: 'Enter UPI ID' },
//   { id: 'authorizedBy', label: 'Authorized By', type: 'text', placeholder: 'Enter authorized person name' },
// ];
...
//   },
//   paymentReceipt: {
//     required: ['paymentDate', 'receiptNo', 'studentName', 'registrationNo', 'courseName', 'courseFees', 'totalAmountPaid', 'paymentMethod'],
//     optional: ['contact', 'address', 'duration', 'upiId', 'authorizedBy']
//   }
// };
...
//       receiptNo: { required: true, pattern: /^[A-Z0-9]+$/ },
//       studentName: { required: true, minLength: 2 },
//       registrationNo: { required: true, pattern: /^[A-Z0-9]+$/ },
//       courseName: { required: true, minLength: 2 },
//       courseFees: { required: true, pattern: /^[0-9]+$/ },
//       totalAmountPaid: { required: true, pattern: /^[0-9]+$/ },
//       paymentMethod: { required: true, minLength: 2 },
//       contact: { pattern: /^\+?[0-9\s-]+$/ },
//       address: { minLength: 5 },
//       duration: { minLength: 2 },
//       upiId: { pattern: /^[a-zA-Z0-9.@]+$/ },
//       authorizedBy: { minLength: 2 },
//     }
//   };
...
export const initialFormData = {
  ...
  // Experience Certificate Template Fields
  experienceParagraph: 'She was conscientious and committed to her work during her tenure with us.',
  experienceClosingStatement: 'We wish her all the best as she embarks on her next professional journey.',
...
const certificateFields = [
  ...
  { id: 'certificateTitle', label: 'Certificate/Position Title', type: 'text', placeholder: 'Enter certificate or position title' },
  { id: 'internshipDuration', label: 'Internship Duration', type: 'text', placeholder: 'e.g., 3 months' },
  { id: 'startDate', label: 'Start Date', type: 'date', placeholder: 'e.g., 2025-05-02' },
  { id: 'endDate', label: 'End Date', type: 'date', placeholder: 'e.g., 2025-07-02' },
  { id: 'completionDate', label: 'Completion Date', type: 'date' },
  { id: 'mentorName', label: 'Mentor/Guide Name', type: 'text', placeholder: 'Enter mentor name' },
  { id: 'referenceNo', label: 'Reference Number', type: 'text', placeholder: 'Enter reference number' },
  { id: 'signatoryName', label: 'Signatory Name', type: 'text', placeholder: 'Enter name of person signing' },
...
const salarySlipFields = [
  ...
  { id: 'employeeName', label: 'Employee Name', type: 'text', width: 'large', placeholder: 'Enter employee name (without title)' },
  { id: 'employeeId', label: 'Employee ID', type: 'text', placeholder: 'Enter employee ID' },
  { id: 'startDate', label: 'Start Date', type: 'date', placeholder: 'Enter start date' },
  { id: 'location', label: 'Location', type: 'text', placeholder: 'Enter location' },
  { id: 'paymentMode', label: 'Payment Mode', type: 'text', placeholder: 'Enter payment mode' },
  { id: 'monthYear', label: 'Month & Year', type: 'text', placeholder: 'Enter month and year (e.g., Dec-2023)' },
  { id: 'calendarDays', label: 'Calendar Days', type: 'text', placeholder: 'Enter calendar days' },
  { id: 'paidDays', label: 'Paid Days', type: 'text', placeholder: 'Enter paid days' },
  { id: 'lop', label: 'Loss of Pay', type: 'text', placeholder: 'Enter loss of pay days' },
  { id: 'accountNo', label: 'Account Number', type: 'text', placeholder: 'Enter account number' },
  { id: 'ifscCode', label: 'IFSC Code', type: 'text', placeholder: 'Enter IFSC code' },
  { id: 'basic', label: 'Basic Salary', type: 'text', placeholder: 'Enter basic salary' },
  { id: 'hra', label: 'HRA', type: 'text', placeholder: 'Enter HRA' },
  { id: 'allowances', label: 'Allowances', type: 'text', placeholder: 'Enter allowances' },
  { id: 'bonus', label: 'Bonus', type: 'text', placeholder: 'Enter bonus' },
  { id: 'employeePF', label: 'Employee PF', type: 'text', placeholder: 'Enter employee PF' },
  { id: 'employeeESI', label: 'Employee ESI', type: 'text', placeholder: 'Enter employee ESI' },
  { id: 'professionalTax', label: 'Professional Tax', type: 'text', placeholder: 'Enter professional tax' },
  { id: 'totalEarnings', label: 'Total Earnings', type: 'text', placeholder: 'Enter total earnings' },
  { id: 'totalDeduction', label: 'Total Deduction', type: 'text', placeholder: 'Enter total deduction' },
  { id: 'netSalary', label: 'Net Salary', type: 'text', placeholder: 'Enter net salary' },
...
const paymentReceiptFields = [
  ...
  { id: 'contact', label: 'Contact', type: 'text', placeholder: 'Enter contact number' },
  { id: 'address', label: 'Address', type: 'textarea', placeholder: 'Enter address' },
  { id: 'duration', label: 'Duration', type: 'text', placeholder: 'Enter duration' },
  { id: 'upiId', label: 'UPI ID', type: 'text', placeholder: 'Enter UPI ID' },
  { id: 'authorizedBy', label: 'Authorized By', type: 'text', placeholder: 'Enter authorized by' }
];
